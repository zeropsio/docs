...
module.exports = {
  homepage: [
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'guides/production-checklist', label: 'Production Checklist', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/scaling', label: 'Scaling', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/networking', label: 'Networking', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/deployment-lifecycle', label: 'Deployment Lifecycle', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/environment-variables', label: 'Environment Variables', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/build-cache', label: 'Build Cache', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/local-development', label: 'Local Development', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/ci-cd', label: 'CI/CD', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/object-storage-integration', label: 'Object Storage Integration', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/cloudflare', label: 'Cloudflare Integration', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/public-access', label: 'Public Access & Domains', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/smtp', label: 'SMTP', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/vpn', label: 'VPN', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/firewall', label: 'Firewall', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/logging', label: 'Logging', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/metrics', label: 'Metrics & Monitoring', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/backup', label: 'Backup', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/cdn', label: 'CDN', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/php-tuning', label: 'PHP Tuning', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/zerops-yaml-advanced', label: 'zerops.yml Advanced', className: 'homepage-sidebar-item' },
      ],
    },
    {
      type: 'category',
      ...
      items: [
        { type: 'doc', id: 'guides/choose-database', label: 'Choose a Database', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/choose-cache', label: 'Choose a Cache', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/choose-queue', label: 'Choose a Message Queue', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/choose-runtime-base', label: 'Choose a Runtime Base', className: 'homepage-sidebar-item' },
        { type: 'doc', id: 'guides/choose-search', label: 'Choose a Search Engine', className: 'homepage-sidebar-item' },
      ],
    },
    {
      type: 'html',
