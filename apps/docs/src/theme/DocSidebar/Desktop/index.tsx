...
function DocSidebarDesktop({ path, sidebar }: Props) {
  ...
  return (
    <div
      className={clsx(
        'lg:flex lg:flex-col lg:max-h-[calc(100vh-57px)] lg:h-full lg:sticky lg:top-0 lg:transition-opacity lg:duration-100 lg:ease-ease lg:pt-1.5',
        'sidebar-desktop',
    ...
    >
      ...
      <Content
        path={path}
        sidebar={sidebar}
        className={clsx('main-sidebar', '!mt-0 !pt-0 !px-1 !pb-4')}
      />
    </div>
  );
}
