...
:::tip
For advanced log analysis, consider setting up [log forwarding](/features/logging#log-forwarding) to external logging services like Better Stack or Papertrail.
:::