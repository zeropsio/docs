...
const TechCard: React.FC<TechCardProps> = ({ heading, description, items }) => {
    return (
        <div className="m-1 p-2 rounded-md bg-[#F2F5F7] dark:bg-medusa-bg-base flex flex-col">
                ...
                {items.map((item, index) => {
                    ...
                    const CardContent = (
                        <div
                            ...
                            ${isClickable ? "cursor-pointer hover:bg-medusa-bg-base active:bg-[#EEF0F2] dark:active:bg-[#2A2C30]"
