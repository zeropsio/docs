...
2. [Create a project description file](/nginx/how-to/shared-storage#create-a-project-description-file)
3. [Create a project with a Nginx static service and a shared storage](/nginx/how-to/shared-storage#create-a-project-with-a-nginx-service-and-a-shared-storage)
