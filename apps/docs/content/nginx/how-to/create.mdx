...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type <code>nginx</code> and version.
        <br />
        Set type:{' '}
        <code>
          nginx<span>@</span>&lt;version&gt;
        </code>{' '}
        or{' '}
        <code>
          nginx<span>@</span>latest
        </code>
        <br />
        <br />
        <b>Limitations:</b>
        <br />
        Following Nginx major versions are currently supported: <i>1.22</i>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <a href="/nginx/how-to/create#set-auto-scaling-configuration">
    ...
    <tr>
      ...
      <td>
        ...
        for{' '}
        <a href="/nginx/how-to/create#horizontal-auto-scaling">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/nginx/how-to/env-variables#env-variable-restrictions">
          restrictions
        </a>
        .
      </td>
