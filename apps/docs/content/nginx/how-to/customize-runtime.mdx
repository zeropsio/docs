...
:::note
To use Ubuntu instead of the default Alpine, set the [run.os](/dotnet/how-to/build-pipeline#os) attribute.

Additional packages and tools can be installed using [build.prepareCommands](/dotnet/how-to/build-pipeline#preparecommands).
:::
