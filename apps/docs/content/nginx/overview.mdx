...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Dive in all Zerops has to offer for your Nginx application.',
    }
  }
]} />
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      icon: Icons['php'],
      description: 'Start with creating a Nginx static service using GUI or zCLI.',
    }
  },
  {
    type: 'link',
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Set up scaling of your Nginx application so that it runs smoothly while using only necessary resources.',
    }
  }
  ]} />
