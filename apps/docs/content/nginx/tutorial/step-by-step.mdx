...
description: Go through the step by step tutorial for nginx on Zerops.
---
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/nginx/how-to/create#create-a-project-description-file">import</a>{' '}
...
<details>
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/nginx/how-to/create#add-nginx-service-to-an-existing-project">
      import a service
    </a>{' '}
