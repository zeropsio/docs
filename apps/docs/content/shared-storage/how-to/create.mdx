...
<p>
    <video width="100%" autoplay="true" loop="loop" muted="muted" plays-inline="true">
        <source src="/img/screenshots/create_shared_storage_cast.mp4" type="video/mp4" />
    </video>
</p>
...
<p align="center">
<img src="/img/screenshots/connect_shared_storage.png" alt="image" width="100%" height="auto"/>
</p>
...
<p align="center">
<img src="/img/screenshots/shared_storage_mode.png" alt="image" width="50%" height="auto"/>
</p>
...
<p align="center">
<img src="/img/screenshots/shared_storage_autoscaling.png" alt="image" width="100%" height="auto"/>
</p>
...
* [Node.js with Shared storage](/nodejs/how-to/create#create-nodejs-service-using-zcli)
* [PHP with Shared storage](/php/how-to/create#create-nodejs-service-using-zcli)
* [Python with Shared storage](/python/how-to/create#create-nodejs-service-using-zcli)
* [Go with Shared storage](/go/how-to/create#create-nodejs-service-using-zcli)
* [.NET with Shared storage](/dotnet/how-to/create#create-nodejs-service-using-zcli)
* [Rust with Shared storage](/rust/how-to/create#create-nodejs-service-using-zcli)
