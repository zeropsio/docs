...
<GroupCards heading="Read about how to create a project description file and create a runtime service with a Shared storage service using zCLI." items={languages} />
