...
<details>
  <summary>
    ...
    contents of this{' '}
    <a href="https://github.com/zeropsio/recipe-bun/blob/main/zerops-project-import.yml">
      yaml file
    </a>{' '}
...
7. Feel free to make any changes to your project, fork the repo or connect your own. Also see other <a href="https://github.com/zeropsio?q=Bun&type=all&language=&sort=">Bun recipes</a> on our Github page.
