...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-onboarding-bun), a **_recipe_**, containing a PostgreSQL service with a simple Bun application. The repo will be used as a source from which the app will be built.
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/bun/how-to/create#create-a-project-description-file">import</a>{' '}
...
<details>
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/bun/how-to/create#add-bun-service-to-an-existing-project">
      import a service
    </a>{' '}
...
<details>
  ...
  <p>
  Learn more about how the pipelines can be <a href="/bun/how-to/trigger-pipeline">triggered</a> and about <a href="/bun/how-to/build-process">build</a> and <a href="/bun/how-to/deploy-process">deploy</a> processes of a Bun application in Zerops.

Learn more about how to access <a href="/bun/how-to/logs#build-log">build log</a> of your Bun service in Zerops.
...
<details>
  ...
  <p>
    Learn more about how to <a href="/bun/how-to/access">access</a> your
    Bun service in Zerops.
  </p>
</details>
...
For now, check out other features, such as <a href="/bun/how-to/env-variables">environment variables</a>, <a href="/bun/how-to/logs#runtime-log">runtime log</a> and <a href="/bun/how-to/scaling">scaling</a>.
...
own. Also see other <a href="https://github.com/zeropsio?q=Bun&type=all&language=&sort=">
  Bun
