...
<table className="w-full my-1.5">
  ...
  <tbody>
    ...
    <tr>
      <td className="w-fit"><strong>location</strong></td>
      <td className="w-fit"><strong>Optional.</strong> The region where the project will be hosted. Values: <strong>eu-central</strong> (EU Central, Prague, default) or <strong>us-east-1</strong> (US East, New York). Cannot be changed after project creation.</td>
      <td className="w-fit"></td>
    </tr>
  </tbody>
</table>
