...
description: Learn about working with PostgresSql with ease on Zerops.
---
  ...
  items={[
    ...
    },
    {
      ...
      customProps: {
        ...
        description:
          'Dive in all Zerops has to offer for your PostgreSQL application.',
      },
    },
    {
      type: 'link',
      ...
      customProps: {
        icon: Icons['github'],
        description:
          'Get inspired by already existing repositories, ready to be imported to Zerops. Filter is applied for simple applications with PostgreSQL, feel free to browse them all.',
      },
    },
  ]}
/>
