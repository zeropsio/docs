...
On Zerops, services talk to each other by hostname — no connection strings to copy and paste. Your `DB_HOST` is just `db`.
:::
...
Push to your repo and move on to Step 6 to connect it to Zerops:
