...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type <code>keydb</code> and version.
        <br />
        Set type:{' '}
        <code>
          keydb<span>@</span>XXX
      ...
      <td>
        Currently only KeyDB <i>XXX</i> is available.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/keydb/how-to/create#set-auto-scaling-configuration">
