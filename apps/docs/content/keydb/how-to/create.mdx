---
title: Create a KeyDB service in Zerops
---
...
**// TODO image (add a new KeyDB page - Automatic scaling section)**
...
**// TODO screenshot (add a new KeyDB page - Automatic scaling section)**

**//TODO review**

KeyDB needs at least 5 vCPUs to start. Zerops automatically starts KeyDB service with at least 5 vCPUs. If the database is idle after the start, Zerops will scale the KeyDB down to selected minimum vCPU settings. If you set the minimum vCPU settings higher than 5 vCPUs, Zerops will start with the required minimum vCPU settings.
...
<tbody>
  ...
  <tr>
    <td><b>verticalAutoscaling</b></td>
		<td><b>Optional.</b> Defines <a href="/keydb/how-to/scale#vertical-scaling">custom auto scaling parameters</a>.</td>
		<td></td>
	</tr>
</tbody>
</table>
