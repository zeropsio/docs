...
import Badge from 'docs/src/components/BadgeTitle';
...
### base <Badge text="Required" color="red" />
...
### os <Badge text="Optional" color="blue" />
...
### prepareCommands <Badge text="Optional" color="blue" />
...
### buildCommands <Badge text="Required" color="red" />
...
### deployFiles <Badge text="Required" color="red" />
...
### envVariables <Badge text="Optional" color="blue" />
...
### base <Badge text="Optional" color="blue" />
...
### ports <Badge text="Optional" color="blue" />
...
### start <Badge text="Required for some runtimes" color="yellow" />
...
### startCommands <Badge text="Optional" color="blue" />
...
### healthCheck <Badge text="Optional" color="blue" />
...
### crontab <Badge text="Optional" color="blue" />
...
### readinessCheck <Badge text="Optional" color="blue" />
