...
This is a list of all currently supported versions of technologies that can be used for <code><a href="/zerops-yml/specification#base-required">build.base</a></code> and <code><a href="/zerops-yml/specification#base">run.base</a></code> sections in `zerops.yml`.
