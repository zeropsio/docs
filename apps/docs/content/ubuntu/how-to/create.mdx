---
title: Create a Ubuntu service in Zerops
description: Learn how you can create a Ubuntu service in Zerops.
---
...
<UnorderedList data={data.ubuntu.readable} />
...
<table className="w-full my-1.5">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="w-fit">
        <strong>Optional.</strong> Defines <a href="/ubuntu/how-to/create#set-auto-scaling-configuration">custom vertical auto scaling parameters</a>.
        <br />
    ...
    <tr>
      ...
      <td className="w-fit">
        <strong>Optional.</strong> Default = 1. Defines the minimum number of containers for <a href="/ubuntu/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.
    ...
    <tr>
      ...
      <td className="w-fit">
        Defines the maximum number of containers for <a href="/ubuntu/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.
    ...
    <tr>
      ...
      <td className="w-fit">
        <strong>Optional.</strong> Defines one or more secret env variables as a key value map. See env variable <a href="/ubuntu/how-to/env-variables#env-variable-restrictions">restrictions</a>.
      </td>
    </tr>
  </tbody>
</table>
