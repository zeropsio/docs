...
zerops:
  ...
  - setup: app
    ...
    run:
      ...
      # REQUIRED. Folder name used as the root of the publicly accessible web server content.
      documentRoot: public
```
...
### documentRoot
_REQUIRED._ Defines the folder name used as the root of the publicly accessible web server content of your PHP application.
