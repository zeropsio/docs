...
The base build environment contains Ubuntu 22, the selected major version of PHP, [Zerops command line tool](/references/cli), `composer`, `git` and `wget`.
...
The base PHP environment contains Ubuntu 22, the selected major version of PHP, [Zerops command line tool](/references/cli) and `composer`, `git` and `wget`. To install additional packages or tools add one or more prepare commands:
...
The prepare runtime container contains Ubuntu 22, the selected major version of PHP, [Zerops command line tool](/references/cli) and `composer`, `git` and `wget`.
