...
Zerops provides 2 PHP services with an included web server: **PHP+Nginx** and **PHP+Apache**. PHP runtime is highly scalable and customizable to suit both development and production.
...
:::tip
Learn more about how to [fine tune](/php/how-to/scaling#fine-tune-the-auto-scaling) the auto scaling to fit your application needs. Refer to [scaling.mdx](/scaling.mdx) for more information.
:::
