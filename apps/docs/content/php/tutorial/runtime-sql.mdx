...
description: Learn how you can work with php & postgres database on Zerops.
---
...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-onboarding-php), a **_recipe_**, containing a PostgreSQL service with a simple PHP application. The repo will be used as a source from which the app will be built.
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/php/how-to/create#create-a-project-description-file">import</a> a
...
<details>
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/php/how-to/create#add-php-service-to-an-existing-project">
      import a service
    </a>{' '}
...
<details>
  ...
  <p>
    Learn more about how to <a href="/php/how-to/access">access</a> your PHP
    service in Zerops.
  </p>
</details>
