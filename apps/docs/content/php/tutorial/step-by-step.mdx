...
description: Go through the step by step tutorial for php on Zerops.
---
...
<details>
  <summary>
    ...
    contents of this{' '}
    <a href="https://github.com/zeropsio/recipe-php-hello-world/blob/main/import-service/description.yml">
      yaml file
    </a>{' '}
