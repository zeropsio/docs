...
description: Learn how you can work with rust & postgres database on Zerops.
---
...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-onboarding-rust), a **_recipe_**, containing a PostgreSQL service with a simple Rust application. The repo will be used as a source from which the app will be built.
...
own. Also see other <a href="https://github.com/zeropsio?q=rust&type=all&language=&sort=">
  Rust
