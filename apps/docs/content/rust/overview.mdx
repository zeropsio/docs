...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Dive in all Zerops has to offer for your Rust application.',
    }
  }
]} />
...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Set up scaling of your Rust application so that it runs smoothly while using only necessary resources.',
    }
  }
  ]} />
  ...
  {
    type: 'link',
    href: '/rust/how-to/build-process#customise-rust-build-environment',
  ...
  {
    type: 'link',
    href: '/rust/how-to/deploy-process#customise-rust-runtime-environment',
