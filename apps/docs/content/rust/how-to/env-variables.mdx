...
description: Learn how you can setup and use environment variables in a rust service on Zerops.
---
...
<table className="rounded-lg w-fit my-1.5">
  ...
  <tbody>
    <tr className="text-center">
      ...
      <td className="w-fit"><a href="/rust/how-to/build-pipeline#envvariables">zerops.yml</a></td>
    </tr>
    <tr className="text-center">
      <td className="w-fit">basic</td>
      <td className="w-fit">runtime</td>
      <td className="w-fit"><a href="/rust/how-to/build-pipeline#envvariables-1">zerops.yml</a></td>
    </tr>
    <tr className="text-center">
