...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type <code>rust</code> and version.
        <br />
        Set type:{' '}
        <code>
          rust<span>@</span>&lt;version&gt;
        </code>{' '}
        or{' '}
        <code>
          rust<span>@</span>latest
        </code>
        <br />
        <br />
        <b>Limitations:</b>
        <br />
        Following Rust major versions are currently supported: <i>1</i>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <a href="/rust/how-to/create#set-auto-scaling-configuration">
    ...
    <tr>
      ...
      <td>
        ...
        for{' '}
        <a href="/rust/how-to/create#horizontal-auto-scaling">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/rust/how-to/env-variables#env-variable-restrictions">
          restrictions
        </a>
        .
      </td>
