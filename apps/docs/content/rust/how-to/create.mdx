...
Rust service with "app" hostname is configured to listen on tcp ports 8080, 8081 and on udp port 9000. Rust service will run on version 18 with a custom vertical and horizontal scaling. Following secret env variables will be configured:
