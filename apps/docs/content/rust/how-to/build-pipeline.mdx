...
<p>The base runtime environment contains {data.alpineCurrentVersion}, the selected major version of Rust, Zerops command line tool, npm, yarn, git and npx tools.</p>
