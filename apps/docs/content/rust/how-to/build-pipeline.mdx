...
<p>
  ...
  <code>npm</code> , <code>yarn</code>, <code>git</code> and <code>npx</code>{' '}
  tools.
</p>
...
<p>
  ...
  major version of Rust, <a href="/references/cli">Zerops command line tool</a>{' '}
  and <code>npm</code> , <code>yarn</code>, <code>git</code> and{' '}
  <code>npx</code> tools. To install additional packages or tools add one or
