...
Zerops provides a customizable build environment for your Rust application.
...
<p>The base build environment contains {data.alpineVersion}, the selected major version of Rust, <a href="/references/cli">Zerops command line tool</a>, `npm`, `yarn`, `git` and `npx` tools.</p>
...
<p>The base Rust environment contains {data.alpineVersion}, the selected major version of Rust, <a href="/references/cli">Zerops command line tool</a> and `npm`, `yarn`, `git` and `npx` tools. To install additional packages or tools add one or more prepare commands:</p>
...
<p>The prepare runtime container contains {data.alpineVersion}, the selected major version of Rust, <a href="/references/cli">Zerops command line tool</a> and `npm`, `yarn`, `git` and `npx` tools.</p>
