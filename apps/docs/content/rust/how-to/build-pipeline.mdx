...
Each service configuration contains two sections: **build** and **run**. Both sections are required to build and deploy your Rust application in Zerops.
...
If you need to upgrade the major Rust version, create a new service with the required version and set a new [hostname](/rust/how-to/build-pipeline#hostname) in your `zerops.yml`.
