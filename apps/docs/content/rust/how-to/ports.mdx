...
## Zerops GUI
To update Rust internal ports, go to your service detail page and choose **Public access & internal ports** in the main menu. There you can edit or remove current ports or add new ones.
...
If the Rust service has the Zerops subdomain enabled, the list of subdomains will be updated automatically to correspond with the new set of internal ports.
...
:::note
Zerops doesn't restart your service after the internal ports have changed. Restart your service manually or perform a [new deploy](/rust/how-to/trigger-pipeline) if needed.
:::
