...
<table className="w-full my-1.5">
  <thead>
    <tr>
      ...
      <th className="w-fit">Method</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td className="w-fit">Node.js 20+</td>
      <td className="w-fit">`node --env-file .env app.js`</td>
    </tr>
    <tr>
      <td className="w-fit">Next.js, Vite, Nuxt</td>
      <td className="w-fit">Automatic (reads `.env`)</td>
    </tr>
    <tr>
      <td className="w-fit">PHP/Laravel</td>
      <td className="w-fit">Automatic (reads `.env`)</td>
    </tr>
    <tr>
      <td className="w-fit">Python</td>
      <td className="w-fit">`python-dotenv` or `django-environ`</td>
    </tr>
    <tr>
      <td className="w-fit">Go</td>
      <td className="w-fit">`godotenv.Load()` or `source .env && go run .`</td>
    </tr>
    <tr>
      <td className="w-fit">Java/Spring</td>
      <td className="w-fit">`spring-dotenv` or `application.properties`</td>
    </tr>
  </tbody>
</table>
...
<table className="w-full my-1.5">
  <thead>
    <tr>
      ...
      <th className="w-fit">Diagnosis</th>
      <th className="w-fit">Fix</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td className="w-fit">`nc -zv db 5432` times out</td>
      <td className="w-fit">VPN not connected</td>
      <td className="w-fit">`zcli vpn up <project-id>`</td>
    </tr>
    <tr>
      <td className="w-fit">VPN connected, still timeout</td>
      <td className="w-fit">Wrong project</td>
      <td className="w-fit">`zcli vpn up <correct-project-id>`</td>
    </tr>
    <tr>
      <td className="w-fit">Connected but auth fails</td>
      <td className="w-fit">Stale .env</td>
      <td className="w-fit">Regenerate from `zerops_discover includeEnvs=true`</td>
    </tr>
    <tr>
      <td className="w-fit">Service unreachable</td>
      <td className="w-fit">Service stopped</td>
      <td className="w-fit">`zerops_manage action="start" serviceHostname="db"`</td>
    </tr>
  </tbody>
</table>
