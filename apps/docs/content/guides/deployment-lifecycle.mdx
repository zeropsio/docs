...
<table className="w-full my-1.5">
  ...
  <tbody>
    <tr>
      ...
      <td className="w-fit">New containers start BEFORE old ones stop</td>
      <td className="w-fit">**Zero downtime**</td>
    </tr>
    <tr>
      <td className="w-fit">`true`</td>
      <td className="w-fit">Old containers stop BEFORE new ones start</td>
      <td className="w-fit">**Temporary downtime**</td>
    </tr>
  </tbody>
</table>
...
<table className="w-full my-1.5">
  <thead>
    <tr>
      <th className="w-fit">Aspect</th>
      <th className="w-fit">Readiness Check</th>
      <th className="w-fit">Health Check</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td className="w-fit">When</td>
      <td className="w-fit">**During deploy only**</td>
      <td className="w-fit">**Continuously after deploy**</td>
    </tr>
    <tr>
      <td className="w-fit">Purpose</td>
      <td className="w-fit">Gates traffic to new containers</td>
      <td className="w-fit">Detects runtime failures</td>
    </tr>
    <tr>
      <td className="w-fit">Location</td>
      <td className="w-fit">`deploy.readinessCheck`</td>
      <td className="w-fit">`run.healthCheck`</td>
    </tr>
    <tr>
      <td className="w-fit">Failure action</td>
      <td className="w-fit">Container marked failed after timeout, replaced</td>
      <td className="w-fit">Container restarted</td>
    </tr>
  </tbody>
</table>
