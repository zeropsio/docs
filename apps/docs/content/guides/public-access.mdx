...
<table className="w-full my-1.5">
  ...
  <tbody>
    <tr>
      ...
      <td className="w-fit">Limited connections, shorter timeouts</td>
    </tr>
    <tr>
      <td className="w-fit">Dedicated IPv4</td>
      <td className="w-fit">$3/30 days</td>
      <td className="w-fit">All protocols</td>
      <td className="w-fit">Non-refundable, auto-renews</td>
    </tr>
    <tr>
      <td className="w-fit">IPv6</td>
      <td className="w-fit">Free</td>
      <td className="w-fit">All protocols</td>
      <td className="w-fit">Dedicated per project</td>
    </tr>
  </tbody>
</table>
