...
<UnorderedList data={data.ruby.readable} />
...
<table className="w-full my-1.5">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="w-fit">
        <b>Optional.</b> Defines <a href="/ruby/how-to/create#set-auto-scaling-configuration">custom vertical auto scaling parameters</a>.<br />
    ...
    <tr>
      ...
      <td className="w-fit">
        ...
        for <a href="/ruby/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.<br />
        <br />
        <b>Limitations:</b>
        <br />
    ...
    <tr>
      ...
      <td className="w-fit">
        Defines the maximum number of containers for <a href="/ruby/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.<br />
        <br />
        <b>Limitations:</b>
        <br />
        Current maximum value = 10.
    ...
    <tr>
      ...
      <td className="w-fit">
        ...
        map. See env variable <a href="/ruby/how-to/env-variables#env-variable-restrictions">restrictions</a>.
      </td>
    </tr>
  </tbody>
</table>
