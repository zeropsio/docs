...
<UnorderedCodeList data={data.ruby.base} />
...
<p>
  ...
  major version of Ruby, <a href="/references/cli">Zerops command line tool</a>, `gem`, `bundler` and `git` tools. A full native-extension
...
- <span>{data.ubuntu.default} or {data.alpine.default} (depending on the chosen base prefix)</span>
...
<p>
  ...
  major version of Ruby, <a href="/references/cli">Zerops command line tool</a> and `gem`, `bundler` and `git` tools. To install
...
<p>
  ...
  selected major version of Ruby, <a href="/references/cli">Zerops command line tool</a> and `gem`, `bundler` and `git` tools.
</p>
...
| Parameter   | Description                                                                                                                                                                                                                                                                                                                     |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **command** | Defines a local command to be run.<br/>The command has access to the same [environment variables](/ruby/how-to/create#set-secret-environment-variables) as your Ruby application.<br/>A single string is required. If you need to run multiple commands create a shell script or, use a multiline format as in the example below. |
