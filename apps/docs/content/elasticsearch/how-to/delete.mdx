---
title: Delete Elasticsearch service
---
## Delete Elasticsearch service in Zerops GUI
...
## Delete Elasticsearch using zCLI
zCLI is the Zerops command-line tool. To delete the Elasticsearch service via the command-line, follow these steps:
