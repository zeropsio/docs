---
title: Delete RabbitMQ service
---
## Delete RabbitMQ service in Zerops GUI
...
## Delete RabbitMQ using zCLI
zCLI is the Zerops command-line tool. To delete the RabbitMQ service via the command-line, follow these steps:
