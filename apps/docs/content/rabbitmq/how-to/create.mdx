...
{/* TODOimage (add a new RabbitMQ page - Automatic scaling section) */}
...
{/* TODOscreenshot (add a new RabbitMQ page - Automatic scaling section) */}
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="w-fit">
        ...
        <br />
        See what [RabbitMQ service types](/references/importyml/type-list#database-services) are currently supported.
      </td>
    </tr>
    <tr>
