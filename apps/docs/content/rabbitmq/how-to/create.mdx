...
<tbody>
  ...
  <td><b>mode</b></td>
    ...
    <br/><b>HA</b><br/>Creates a RabbitMQ cluster with 3 database containers and 2 free database proxies. This mode is suited for production.<br/><br/>
