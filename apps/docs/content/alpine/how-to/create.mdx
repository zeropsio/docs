---
title: Create a Alpine service in Zerops
description: Learn how you can create a Alpine service in Zerops.
---
...
<UnorderedList data={data.alpine.readable} />
...
:::note
This file is **not** `zerops.yml`. This is a one-time infrastructure setup — use it to provision a Zerops project and its services via the CLI or by pasting into the GUI import dialog. Your app's [`zerops.yml`](/zerops-yaml/specification) lives in your source repository and controls how the app is built and deployed on every push.
:::
...
<table className="w-full my-1.5">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="w-fit">
        <strong>Optional.</strong> Defines <a href="/alpine/how-to/create#set-auto-scaling-configuration">custom vertical auto scaling parameters</a>.
        <br />
    ...
    <tr>
      ...
      <td className="w-fit">
        <strong>Optional.</strong> Default = 1. Defines the minimum number of containers for <a href="/alpine/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.
    ...
    <tr>
      ...
      <td className="w-fit">
        Defines the maximum number of containers for <a href="/alpine/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.
    ...
    <tr>
      ...
      <td className="w-fit">
        <strong>Optional.</strong> Defines one or more secret env variables as a key value map. See env variable <a href="/alpine/how-to/env-variables#env-variable-restrictions">restrictions</a>.
      </td>
    </tr>
  </tbody>
</table>
