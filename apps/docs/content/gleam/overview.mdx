...
description: Learn about working with Gleam with ease on Zerops.
---
...
<DocCardList
  ...
  items={[
    ...
    {
      type: 'link',
      href: '/gleam/how-to/build-pipeline#add-zeropsyml-to-your-repository',
      label: 'Zerops.yml',
      customProps: {
        icon: Icons['puzzle'],
        description:
...
<DocCardList
  ...
  items={[
    {
      type: 'link',
      href: '/gleam/how-to/build-process#customise-gleam-build-environment',
