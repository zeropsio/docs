...
<p>
  <video
    ...
    plays-inline="true"
  >
    <source src="/img/screenshots/create_gleam_cast.mp4" type="video/mp4" />
  </video>
</p>
...
[Learn more](/gleam/how-to/scaling) about Node.js auto scaling in Zerops.
...
Node.js service with "app" hostname, the internal port(s) the service listens on will be defined later in the [zerops.yml](/gleam/how-to/build-pipeline#ports). Node.js service will run on version 20 with a custom vertical and horizontal scaling. Following secret env variables will be configured:
