...
{/* TODO screenrecording of the creation of gleam service */}


### Choose a Gleam version

Zerops supports the following Gleam major versions:

<UnorderedList data={data.gleamMajorVersions} />
...
Gleam service with "app" hostname, the internal port(s) the service listens on will be defined later in the [zerops.yml](/gleam/how-to/build-pipeline#ports). Gleam service will run on version 20 with a custom vertical and horizontal scaling. Following secret env variables will be configured:
...
At least one service in `services:` section is required. You can create a project with multiple services. The example above contains Gleam and PostgreSQL services but you can create a `description.yml` with your own combination of [services](/features/infrastructure).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type `gleam` and version.
        <br />
        Set type:{' '}
        `
          gleam<span>@</span>&lt;version&gt;
        `{' '}
        or{' '}
        `
          gleam<span>@</span>latest
        `
        <br />
        <br />
        <b>Limitations:</b>
        <br />
        Following Gleam major versions are currently supported: <i>20</i>,
        <i>18</i>,<i>16</i>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <a href="/gleam/how-to/create#set-auto-scaling-configuration">
    ...
    <tr>
      ...
      <td>
        ...
        for{' '}
        <a href="/gleam/how-to/create#horizontal-auto-scaling">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/gleam/how-to/env-variables#env-variable-restrictions">
          restrictions
        </a>
        .
      </td>
