...
description: Learn how to create shared storage which you can use with your node.js service on Zerops.
---
...
3. [Create a project with a Node.js service and a shared storage](/gleam/how-to/shared-storage#create-a-project-with-a-gleam-service-and-a-shared-storage)
...
[Read the basics](/gleam/how-to/create#create-a-project-description-file) how to define the Node.js service using the description.yml.
