...
You can set env variables when you [create](/gleam/how-to/create) a new Node.js service or you can set them later.
...
<p align="center">
  <img
    src="/img/screenshots/gleam_generated_variables.png"
    alt="image"
    width="100%"
    height="auto"
  />
