...
<table className="w-full rounded-lg my-1.5 text-center">
  <thead>
    <tr>
      <th className="w-fit">Suffix</th>
      <th className="w-fit">Description</th>
      <th className="w-fit">How to use with: <code>{'<@generateED25519Key(<Key>)>'}</code></th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
### Output of the import YAML script
...
<table className="w-full rounded-lg my-1.5 text-center">
  <thead>
    <tr>
      <th className="w-fit">Suffix</th>
      <th className="w-fit">Description</th>
      <th className="w-fit">How to use with: <code>{'<@generateRSA2048Key(<Key>)>'}</code></th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table className="w-full rounded-lg my-1.5 text-center">
  <thead>
    <tr>
      <th className="w-fit">Suffix</th>
      <th className="w-fit">Description</th>
      <th className="w-fit">How to use with: <code>{'<@generateRSA4096Key(<Key>)>'}</code></th>
    </tr>
  </thead>
  <tbody>
    <tr>
