...
To test your application, you can enable public access through zerops.io subdomain. Go to the service detail page in Zerops GUI and select **Public access & internal ports** in the left menu. Then toggle the **Zerops subdomain access** switch. Zerops will assign the unique zerops.io subdomain for your application. If you have defined more internal ports with http support in your zerops.yml, Zerops will create the unique zerops.io subdomain for each port. Learn more about how to define internal ports for your runtime:
...
<p align="center">
<img src="/img/screenshots/public_access_1.png" alt="image" width="70%" height="auto"/>
</p>
...
<p align="center">
<img src="/img/screenshots/public_access_2.png" alt="image" width="70%" height="auto"/>
</p>
...
<p align="center">
<img src="/img/screenshots/public_access_3.png" alt="image" width="70%" height="auto"/>
</p>
