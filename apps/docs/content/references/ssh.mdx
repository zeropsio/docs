...
- For persistent changes across all containers, use:
  - [`run.prepareCommands`](https://docs.zerops.io/references/zeropsyml#preparecommands-1)
  - [`run.initCommands`](https://docs.zerops.io/references/zeropsyml#initcommands)