...
This is a list of all currently supported versions of technologies that can be used for <code><a href="/references/zeropsyml#base-required">build.base</a></code> and <code><a href="/references/zeropsyml#base-optional">run.base</a></code> sections in `zerops.yml`.
