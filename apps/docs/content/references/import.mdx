---
title: Zerops Project Import YAML Configuration
description: Learn how to define and import a project using a YAML configuration file
---

This section provides a comprehensive example of an import YAML configuration file, allowing you to define and import a project along with its services.

:::caution
Please note that this is a general guideline, and not all keys are valid for every service type. For technology-specific details, refer to the **Create service** page in the **How To** section of the Zerops documentation.
:::
