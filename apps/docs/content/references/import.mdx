    ...
    <table className="w-full my-1.5">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td className="w-fit">string</td>
          <td className="w-fit">[Core package](/features/infrastructure#project-core) of the new project. <br/>Values: <b>LIGHT</b>/<b>SERIOUS</b> (default LIGHT)</td>
        </tr>
        <tr>
...
<Dropdown>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="w-fit">Environment variables in .env file format that are automatically created as secret envs. Supports the [yamlPreprocessor](/references/import-yaml/pre-processor) directive.</td>
    </tr>
    <tr>
...
<table className="w-full my-1.5">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td className="w-fit">Contains the full [zerops.yaml configuration](/zerops-yaml/specification), including the 'zerops:' root element. If provided, this will be used instead of looking for a `zerops.yaml` file in the repository.</td>
    </tr>
  </tbody>
</table>
