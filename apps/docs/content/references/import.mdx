...
description: Learn how you can write an import yaml for importing a project.
---

This section provides an example of an import YAML configuration file for Zerops.

:::caution
Consider this a guideline only. Not all keys are valid for all service types. Check the **Create service** page in the **How To** section for technology-specific details.
:::
