...
:::info
<code>log.trace</code>, <code>log.info</code>, <code>log.debug</code>, <code>log.warn</code>, <code>log.error</code>, and <code>log.fatal</code> are just aliases to the <code>log.Info</code> method. They don't set the appropriate severity number. Use the <code>&lt;N&gt;</code> prefix instead.
:::