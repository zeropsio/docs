...
<tbody>
	...
	<tr>
    <td><b>type</b></td>
		<td>Specifies the service type <code>java</code> and version.<br/>Set type: <code>java<span>@</span>&lt;version&gt;</code><br/><br/><b>Limitations:</b><br/>Following Java major versions are currently supported: <i>1.22</i></td>
	</tr>
