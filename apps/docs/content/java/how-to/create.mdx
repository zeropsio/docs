...
<tr>
  ...
  <td>
    ...
    <a href="/java/how-to/create#set-auto-scaling-configuration">
...
<tr>
  ...
  <td>
    ...
    <a href="/java/how-to/create#horizontal-auto-scaling">
...
<tr>
  ...
  <td>
    <b>Optional.</b> Default = 1. Defines the maximum number of containers for{' '}
    <a href="/java/how-to/create#horizontal-auto-scaling">
      horizontal autoscaling
    </a>
    .<br />
