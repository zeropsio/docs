...
<tbody>
  ...
  <td><b>verticalAutoscaling</b></td>
		<td><b>Optional.</b> Defines <a href="/java/how-to/create#set-auto-scaling-configuration">custom vertical auto scaling parameters</a>.<br/>
  ...
  <tr>
    <td><b>maxContainers</b></td>
		<td><b>Optional.</b> Default = 1. Defines the maximum number of containers for <a href="/java/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.<br/><br/><b>Limitations:</b><br/>Current maximum value = 6.</td>
	</tr>
