...
<tbody>
    ...
    <tr>
    <td><b>type</b></td>
    	<td>Specifies the service type `java` and version.<br/>Set type: `java<span>@</span>&lt;version&gt;` or `java<span>@</span>latest`<br/><br/><b>Limitations:</b><br/>Following Java major versions are currently supported: <i>1.22</i></td>
    </tr>
