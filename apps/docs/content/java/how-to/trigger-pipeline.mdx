...
description: Learn how to trigger build & deploy pipeline in java service on Zerops.
---
...
1. Add <a href="/java/how-to/build-pipeline#add-zeropsyml-to-your-repository">`zerops.yml`</a> to your repository.
