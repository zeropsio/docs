...
:::info
Do not use <code>https://</code> when communicating with Java from other runtime services in the same project. The internal communication is done over a private network and is isolated from other projects.
:::
...
:::info
Do not use <code>https://</code> when communicating with Java over the VPN. The security is assured by the VPN. The internal communication is done over a private network and is isolated from other projects.
:::
...
By default, your Java service is not publicly accessible. To test your application, enable the [public access through zerops.io subdomain](/references/public-access#public-access-through-zeropsio-subdomain).

## Public access through your domain
By default, your Java service is not publicly accessible. When your application is ready for production or if you want to test it on the production domain, [configure the public access through your domain](/references/public-access#public-access-through-your-domain).
