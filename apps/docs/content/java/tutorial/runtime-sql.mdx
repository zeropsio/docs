...
description: Learn how you can work with java & postgres database on Zerops.
---
...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-onboarding-java), a **_recipe_**, containing a PostgreSQL service with a simple Java application. The repo will be used as a source from which the app will be built.
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/java/how-to/create#create-a-project-description-file">import</a> a
    whole project into Zerops.
  </p>
</details>
...
<details>
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/java/how-to/create#add-java-service-to-an-existing-project">
      import a service
    </a>{' '}
...
<details>
  ...
  <p>
    Learn more about how to <a href="/java/how-to/access">access</a> your Java
    service in Zerops.
  </p>
</details>
