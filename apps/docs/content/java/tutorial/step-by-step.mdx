...
description: Go through the step by step tutorial for java on Zerops.
---
...
<details>
  <summary>
    ...
    contents of this{' '}
    <a href="https://github.com/zeropsio/recipe-java-hello-world/blob/main/import-service/description.yml">
      yaml file
    </a>{' '}
