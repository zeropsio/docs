...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Dive in all Zerops has to offer for your Java application.',
    }
  }
]} />
...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Set up scaling of your Java application so that it runs smoothly while using only necessary resources.',
    }
  }
  ]} />
  ...
  {
    type: 'link',
    href: '/java/how-to/deploy-process#customise-java-runtime-environment',
