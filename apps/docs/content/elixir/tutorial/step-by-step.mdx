...
description: Go through the step by step tutorial for Elixir on Zerops.
---
...
<details>
  <summary>
    ...
    contents of this{' '}
    <a href="https://github.com/zeropsio/recipe-elixir/blob/main/zerops-project-import.yml">
      yaml file
    </a>{' '}
...
7. Feel free to make any changes to your project, fork the repo or connect your own. Also see other <a href="https://github.com/zeropsio?q=elixir&type=all&language=&sort=">Elixir recipes</a> on our Github page.
