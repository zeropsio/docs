---
title: Elixir + PostgreSQL tutorial
description: Learn how you can work with Elixir & postgres database on Zerops.
---
...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-onboarding-elixir), a **_recipe_**, containing a PostgreSQL service with a simple Elixir application. The repo will be used as a source from which the app will be built.
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/elixir/how-to/create#create-a-project-description-file">import</a>{' '}
...
<details>
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/elixir/how-to/create#add-elixir-service-to-an-existing-project">
      import a service
    </a>{' '}
...
<details>
  ...
  <p>
  Learn more about how the pipelines can be <a href="/elixir/how-to/trigger-pipeline">triggered</a> and about <a href="/elixir/how-to/build-process">build</a> and <a href="/elixir/how-to/deploy-process">deploy</a> processes of a Elixir application in Zerops.

Learn more about how to access <a href="/elixir/how-to/logs#build-log">build log</a> of your Elixir service in Zerops.
...
<details>
  ...
  <p>
    Learn more about how to <a href="/elixir/how-to/access">access</a> your
    Elixir service in Zerops.
  </p>
</details>
...
For now, check out other features, such as <a href="/elixir/how-to/env-variables">environment variables</a>, <a href="/elixir/how-to/logs#runtime-log">runtime log</a> and <a href="/elixir/how-to/scaling">scaling</a>.
...
own. Also see other <a href="https://github.com/zeropsio?q=elixir&type=all&language=&sort=">
  Elixir
