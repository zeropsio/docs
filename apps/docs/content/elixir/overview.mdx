...
description: Learn about working with Elixir with ease on Zerops.
---
...
2. In the **Projects** box click on **Import a project** and paste in the following yml config ([source ↗](https://github.com/zeropsio/recipe-elixir/blob/main/zerops-project-import.yml)):
...
<DocCardList
  ...
  items={[
    ...
    {
      type: 'link',
      href: '/elixir/how-to/build-pipeline#add-zeropsyml-to-your-repository',
      label: 'Zerops.yml',
      customProps: {
        icon: Icons['puzzle'],
        description:
...
<DocCardList
  ...
  items={[
    {
      type: 'link',
      href: '/elixir/how-to/build-process#customise-elixir-build-environment',
