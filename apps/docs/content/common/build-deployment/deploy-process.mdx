...
:::caution
Do not use the `initCommands` for customising your runtime environment. See [how to customise the runtime environment](/common/build-deployment/build-pipeline#preparecommands-1).
:::
