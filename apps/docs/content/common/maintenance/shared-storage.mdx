...
description: Learn how to create shared storage which you can use with your service on Zerops.
---
...
Connect your service directly when creating a new shared storage service. Just select your service in the **Share with Services** block on the **Add new shared storage service** page.

![connect_shared_storage_1](/img/screenshots/connect_shared_storage_1.png)

To connect the existing shared storage to the service, go to the shared storage service detail and select **Shared storage connections**. A list of all your current runtime services will be shown. Select a runtime service and the shared storage will be connected to the selected runtime.
...
## Create service with a shared storage using zCLI
...
2. [Create a project description file](/common/maintenance/shared-storage#create-a-project-description-file)
3. [Create a project with a runtime service and a shared storage](/common/maintenance/shared-storage#create-a-project-with-a-service-and-a-shared-storage)
...
[Read the basics](/common/management/create#create-a-project-description-file) how to define the service using the description.yml.
...
### Create a project with a service and a shared storage

Follow the page [How to create a project based on the description.yml](/common/management/create#create-a-project-based-on-the-descriptionyml).
