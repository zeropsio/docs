...
To install additional packages or tools add one or more <a href="/go/how-to/build-pipeline#prepare-1"><code>run.prepare</code></a> commands to your `zerops.yml`.
...
1. Content of the <a href=""><code>build.addToRunPrepare</code></a> and <a href="/go/how-to/build-pipeline#prepare-1"><code>run.prepare</code></a> attributes didn't change from the previous deploy
