...
description: Learn how to create shared storage which you can use with your go service on Zerops.
---
...
[Read the basics](/go/how-to/create#create-a-project-description-file) how to define the Go service using the description.yml.
...
Follow the article [How to create a project based on the description.yml](/go/how-to/create#create-a-project-based-on-the-descriptionyml).
