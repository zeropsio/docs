...
:::info
<code>slog.Info</code>, <code>slog.Debug</code>, <code>slog.Warn</code>, and <code>slog.Error</code> are just aliases to the <code>slog.Info</code> method. They don't set the appropriate severity number. Use the <code>&lt;N&gt;</code> prefix instead.
:::