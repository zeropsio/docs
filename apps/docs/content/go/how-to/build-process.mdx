...
To install additional packages or tools add one or more [build.prepareCommands](/go/how-to/build-pipeline#preparecommands) commands to your `zerops.yml`.
...
1. Content of the [build.base](/go/how-to/build-pipeline#base) and [build.prepareCommands](/go/how-to/build-pipeline#preparecommands) attributes didn't change from the previous build
