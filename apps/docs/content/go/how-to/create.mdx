...
<tr>
  ...
  <td>
    ...
    <a href="/go/how-to/create#set-auto-scaling-configuration">
...
<tr>
  ...
  <td>
    <b>Optional.</b> Accepts <code>SHARED</code>, <code>DEDICATED</code> values.
...
<tr>
  ...
  <td>
    <b>Optional.</b> Default = 1. Defines the minimum number of containers for{' '}
    <a href="/go/how-to/create#horizontal-auto-scaling">
...
<tr>
  ...
  <td>
    ...
    <a href="/go/how-to/env-variables#env-variable-restrictions">
      restrictions
    </a>
    .
  </td>
