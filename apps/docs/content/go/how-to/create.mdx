...
<tbody>
    ...
    <tr>
    <td><b>type</b></td>
    	<td>Specifies the service type `go` and version.<br/>Set type: `go<span>@</span>&lt;version&gt;` or `go<span>@</span>latest`<br/><br/><b>Limitations:</b><br/>Following Go major versions are currently supported: <i>1.22</i></td>
    </tr>
