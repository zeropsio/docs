...
For example, to connect to a Go service with hostname = "app" and port = 8080 from another service of the same project, simply use `app:8080`. Read more about [how to access a Go service].
...
**// TODO screenshot (add a new Go service page - Automatic scaling section)**
...
:::caution
Check if your application is ready for [highly available mode]. If not, set the maximum containers to **1**. Zerops will never add more containers to your Go service.
:::
...
Go service with "app" hostname is configured to listen on tcp ports 8080, 8081 and on udp port 4000. Go service will run on version 1 with a custom vertical and horizontal scaling. Following env variables will be configured:
...
<tbody>
	...
	<tr>
  <td><b>type</b></td>
		<td>Specifies the service type <code>go</code> and version.<br/>Set type: <code>go<span>@</span>&lt;version&gt;</code><br/><br/><b>Limitations:</b><br/>Following Go major versions are currently supported: <i>v18</i>,<i>v16</i>,<i>v14</i></td>
	</tr>
    <tr>
  <td><b>ports</b></td>
...
Learn more about [how to connect to your Go service].<br/>
        </td>
	</tr>
    <tr>
