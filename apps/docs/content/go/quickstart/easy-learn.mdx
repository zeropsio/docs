...
<details><summary>3. In the left menu, click on <b>Import services</b>, copy & paste the contents of this <a href="https://github.com/zeropsio/recipe-go-hello-world/blob/main/import.yml">yaml file</a> and click on <b>Import service</b>.</summary>
<p>
