...
2. In the **Projects** box click on **Import a project** and paste in the following yml config ([source](https://github.com/zeropsio/recipe-go-hello-world/blob/main/import-as-project.yml)):
