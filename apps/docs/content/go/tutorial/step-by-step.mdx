...
description: Go through the step by step tutorial for go on Zerops.
---
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/go/how-to/create#create-a-project-description-file">import</a> a
...
<details>
  <summary>
    ...
    contents of this{' '}
    <a href="https://github.com/zeropsio/recipe-go-hello-world/blob/main/import-service/description.yml">
      yaml file
    </a>{' '}
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/go/how-to/create#add-go-service-to-an-existing-project">
      import a service
    </a>{' '}
