...
<details>
  <summary>
    3. In the left menu, click on <b>Import services</b>, copy & paste the contents of the `import-services.yml` config file from the recipe repository of your choice. Then click on <b>Import service</b>.
  </summary>
  <p>
