...
description: Learn how you can setup and use environment variables in a dotnet service on Zerops.
---
...
| ----------- | ------ | --------------------------------------------------------------------------------- |
| build       | basic  | [zerops.yml](/dotnet/how-to/build-pipeline#envvariables)                          |
| runtime     | basic  | [zerops.yml](/dotnet/how-to/build-pipeline#envvariables-1)                        |
| runtime     | secret | [Zerops GUI](/dotnet/how-to/env-variables#set-secret-env-variables-in-zerops-gui) |
