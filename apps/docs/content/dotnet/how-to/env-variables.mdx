...
To configure env variables for an existing service, .NET to the service detail and choose **Environment variables** in the left menu. Click on the **Add new variable** button and set variable key and value.
