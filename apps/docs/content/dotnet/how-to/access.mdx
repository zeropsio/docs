...
description: Learn more about how you can access your dotnet application on Zerops.
---
...
By default, your .NET service is not publicly accessible. To test your application, enable the [public access through zerops.io subdomain](/features/access#public-access-through-zeropsio-subdomain).
