...
description: Learn how to create shared storage which you can use with your dotnet service on Zerops.
---
...
3. [Create a project with a .NET service and a shared storage](/dotnet/how-to/shared-storage#create-a-project-with-a-dotnet-service-and-a-shared-storage)
...
[Read the basics](/dotnet/how-to/create#create-a-project-description-file) how to define the .NET service using the description.yml.
...
Follow the article [How to create a project based on the description.yml](/dotnet/how-to/create#create-a-project-based-on-the-descriptionyml).
