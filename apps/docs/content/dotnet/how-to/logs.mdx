...
:::info
<code>logger.LogTrace</code>, <code>logger.LogInformation</code>, <code>logger.LogWarning</code>, <code>logger.LogDebug</code>, <code>logger.LogError</code> and <code>logger.LogCritical</code> are just aliases to the <code>logger.LogInformation</code> method. They don't set the appropriate severity number. Use the <code>&lt;N&gt;</code> prefix instead.
:::