...
* Ubuntu 22
* selected version of .NET defined in `zerops.yml` [build.base](/dotnet/how-to/build-pipeline#base) parameter
* [zCLI](/references/cli/install), Zerops command line tool
* ASP .NET` and `git`

To install additional packages or tools add one or more [build.prepareCommands](/dotnet/how-to/build-pipeline#preparecommands) commands to your `zerops.yml`.
