...
:::note
To use Ubuntu instead of the default Alpine, set the [build.os](/zerops-yml/specification#os-optional) attribute.

Additional packages and tools can be installed using [build.prepareCommands](/zerops-yml/specification#preparecommands-optional).
:::
