  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <b>Limitations:</b>
        <br />
        Following .NET major versions are currently supported: <i>6</i>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <a href="/dotnet/how-to/create#set-auto-scaling-configuration">
    ...
    <tr>
      ...
      <td>
        ...
        for{' '}
        <a href="/dotnet/how-to/create#horizontal-auto-scaling">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/dotnet/how-to/env-variables#env-variable-restrictions">
          restrictions
        </a>
        .
      </td>
