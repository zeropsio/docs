...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Dive in all Zerops has to offer for your .NET application.',
    }
  }
]} />
...
<DocCardList colSize={4} items={[
  ...
  {
    type: 'link',
    href: '/dotnet/how-to/build-pipeline#add-zeropsyml-to-your-repository',
    label: 'Zerops.yml',
    customProps: {
      icon: Icons['puzzle'],
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Set up scaling of your .NET application so that it runs smoothly while using only necessary resources.',
    }
  }
  ]} />
  ...
  {
    type: 'link',
    href: '/dotnet/how-to/build-process#customise-dotnet-build-environment',
  ...
  {
    type: 'link',
    href: '/dotnet/how-to/deploy-process#customise-dotnet-runtime-environment',
