---
title: .NET overview
description: Learn about working with Dotnet with ease on Zerops.
---
...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-dotnet), a **_recipe_**, containing the most simple .NET web application. The repo will be used as a source from which the app will be built.
...
services:
  - hostname: helloworld
    ...
    minContainers: 1
    maxContainers: 3
    buildFromGit: https://github.com/zeropsio/recipe-dotnet@main
