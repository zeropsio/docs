...
description: Learn how you can work with dotnet & postgres database on Zerops.
---
...
As said, there is no need for coding yet, we have created a [Github repository ↗](https://github.com/zeropsio/recipe-onboarding-dotnet), a **_recipe_**, containing a PostgreSQL service with a simple .NET application. The repo will be used as a source from which the app will be built.
...
<details>
  ...
  <p>
    ...
    Zerops. See how to{' '}
    <a href="/dotnet/how-to/create#create-a-project-description-file">import</a>{' '}
...
<details>
  ...
  <p>
    ...
    Zerops and how to{' '}
    <a href="/dotnet/how-to/create#add-dotnet-service-to-an-existing-project">
      import a service
    </a>{' '}
...
<details>
  ...
  <p>
    Learn more about how to <a href="/dotnet/how-to/access">access</a> your .NET
    service in Zerops.
  </p>
</details>
