...
This quick start allows you to get a hands-on experience of Zerops. Whether you only want to see it in action or want to start small and scale up the project size later an existing Node.js application up and running easily. If you are interested in more detailed guides for your own application, head to the [How to](/nodejs/how-to/create) section.
...
1. In Zerops GUI create a project called `my-project`.
