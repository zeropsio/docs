...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Set up scaling of your Node.js application so that it runs smoothly while using only necessary resources.',
    }
  }
  ]} />
  ...
  {
    type: 'link',
    href: '/nodejs/how-to/build-process#customise-nodejs-build-environment',
  ...
  {
    type: 'link',
    href: '/nodejs/how-to/deploy-process#customise-nodejs-runtime-environment',
