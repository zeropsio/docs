...
1. Content of the <a href=""><code>build.addToRunPrepare</code></a> and <a href="/nodejs/how-to/build-pipeline#prepare-1"><code>run.prepare</code></a> attributes didn't change from the previous deploy
