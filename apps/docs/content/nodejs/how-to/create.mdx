...
Learn more about [how to connect to your Node.js service].<br/>
  ...
  <td><b>minContainers</b></td>
		<td>Defines the minimum number of containers for <a href="/nodejs/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.</td>
		<td>Current maximum value = 6.</td>
	</tr>
        <tr>
  <td><b>maxContainers</b></td>
		<td>Defines the maximum number of containers for <a href="/nodejs/how-to/create#horizontal-auto-scaling">horizontal autoscaling</a>.</td>
		<td>Current maximum value = 6.</td>
	</tr>
        <tr>
