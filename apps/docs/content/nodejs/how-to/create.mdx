...
Specify one or more internal ports on which your application will listen.

The TCP port **3000** is predefined. 
...
:::info
At least one internal port is required for Node.js service.
:::
