...
<tbody>
	...
	<tr>
  <td><b>type</b></td>
		<td>Specifies the service type <code>nodejs</code> and version.<br/>Set type: <code>nodejs<span>@</span>&lt;version&gt;</code><br/><br/><b>Limitations:</b><br/>Following Node.js major versions are currently supported: <i>v18</i>,<i>v16</i>,<i>v14</i></td>
	</tr>
    <tr>
  <td><b>ports</b></td>
