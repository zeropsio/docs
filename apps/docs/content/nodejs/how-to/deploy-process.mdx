...
:::caution
Do not use the <code>initCommands</code> for customising your runtime environment. See [how to customise the runtime environment](/nodejs/how-to/deploy-process#customise-nodejs-runtime-environment).
:::
