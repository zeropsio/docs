...
:::info
If your application needs to be initialized in each runtime container, add [init commands](/nodejs/how-to/build-pipeline#initcommands) to <code>zerops.yml</code>.
:::

:::caution
Do not use the <code>initCommands</code> for customising your runtime environment. See [how to customise the runtime environment](/nodejs/how-to/build-pipeline#preparecommands-1).
:::
