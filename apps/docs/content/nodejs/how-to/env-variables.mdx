...
<table className="rounded-lg w-fit my-1.5">
  ...
  <tbody>
    <tr className="text-center">
      ...
      <td className="w-fit"><a href="/nodejs/how-to/build-pipeline#envvariables">zerops.yml</a></td>
    </tr>
    <tr className="text-center">
      <td className="w-fit">basic</td>
      <td className="w-fit">runtime</td>
      <td className="w-fit"><a href="/nodejs/how-to/build-pipeline#envvariables-1">zerops.yml</a></td>
    </tr>
    <tr className="text-center">
...
### Set secret env variables when importing a service

You can set secret variables in two ways:

### Using Import Features
