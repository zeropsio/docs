...
<p>The base build environment contains {data.alpineVersion}, the selected major version of Node.js, <a href="/references/cli">Zerops command line tool</a>, `npm`, `yarn`, `git` and `npx` tools.</p>
...
<p>The base runtime environment contains {data.alpineVersion}, the selected major version of Node.js, Zerops command line tool, `npm`, `yarn`, `git` and `npx` tools.</p>
...
<p>The base Node.js environment contains {data.alpineVersion} the selected major version of Node.js, <a href="/references/cli">Zerops command line tool</a> and `npm`, `yarn`, `git` and `npx` tools. To install additional packages or tools add one or more prepare commands:</p>
...
<p>The prepare runtime container contains {data.alpineVersion}, the selected major version of Node.js, <a href="/references/cli">Zerops command line tool</a> and `npm`, `yarn`, `git` and `npx` tools.</p>
