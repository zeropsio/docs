...
For the local alternative, see [How to run ZCP on your machine](/zcp/setup/local-agent-bridge). For the tradeoffs, see [Remote or local ZCP setup](/zcp/setup/choose-workspace).
...
### New Zerops setup with ZCP enabled
...
After authentication, Claude Code is connected to ZCP and ready to work from the Browser VS Code terminal. If the workspace was already authorized, use the same route to resume or supervise work.
