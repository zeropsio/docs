...
- [Remote or local setup](/zcp/setup/choose-workspace) - compare development setups.
- [Build and ship](/zcp/workflows/build-with-zcp) - the dev/stage loop this policy assumes.
