...
description: 'Precise ZCP MCP terms for setup routes, develop flow, runtime layouts, delivery modes, failure categories, and completion evidence.'
---

Exact vocabulary for ZCP MCP reference, audits, policies, and handoffs. Day-to-day prompts should describe outcomes.
...
| ---------------------- | ------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| ZCP MCP setup          | Where the `zcp` binary runs: remote `zcp@1` service or local machine.          | No app code should be deployed to the setup itself.             |
...
The develop loop is the main workflow cycle. It closes only when reachability and requested behavior both pass.
...
| Question                                        | Evidence                                                                  |
| ----------------------------------------------- | ------------------------------------------------------------------------- |
| Which setup route and runtime layout were used? | Workflow status, service metadata, service list.                          |
...
Operation-name reference lives in [ZCP MCP tools](/zcp/reference/mcp-operations). Recovery shortcuts live in [Troubleshooting](/zcp/reference/troubleshooting).
