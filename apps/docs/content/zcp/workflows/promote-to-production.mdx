...
- [Build and ship](/zcp/workflows/build-with-zcp#prepare-production-promotion) - where production promotion fits into normal agent work.
- [Production boundary](/zcp/security/production-policy) - why production stays outside the agent loop.
- [CI/CD with Zerops](/guides/ci-cd) - delivery options for production release paths.
