...
Production hardening details live in the [Production Checklist for Zerops](/guides/production-checklist). This page only defines the handoff from verified dev or stage work into production authority.
...
<DocCardList items={[
  {
    type: 'link',
    href: '/zcp/workflows/build-with-zcp#prepare-production-promotion',
    label: 'Build and ship',
    description: 'Where production promotion fits into normal agent work.',
  },
  {
    type: 'link',
    href: '/zcp/security/production-policy',
    label: 'Production boundary',
    description: 'Why production stays outside the agent loop.',
  },
  {
    type: 'link',
    href: '/guides/ci-cd',
    label: 'CI/CD with Zerops',
    description: 'Delivery options for production release paths.',
  },
  {
    type: 'link',
    href: '/references/import',
    label: 'Import & Export YAML Configuration',
    description: 'Project export and import reference.',
  },
  {
    type: 'link',
    href: '/references/networking/public-access',
    label: 'Public Access Configuration',
    description: 'Custom domains, DNS, SSL, and production public access.',
  },
]} />
