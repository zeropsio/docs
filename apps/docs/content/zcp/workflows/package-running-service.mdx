...
<DocCardList items={[
  {
    type: 'link',
    href: '/zcp/workflows/build-with-zcp#package-a-verified-runtime',
    label: 'Build and ship',
    description: 'Where packaging fits into normal agent work.',
  },
  {
    type: 'link',
    href: '/zcp/workflows/promote-to-production',
    label: 'Promote to production',
    description: 'Create production infrastructure and release from git.',
  },
  {
    type: 'link',
    href: '/references/import',
    label: 'Import & Export YAML Configuration',
    description: 'Zerops import file reference for the generated bundle.',
  },
]} />
