...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Dive in all Zerops has to offer for your Python application.',
    }
  }
]} />
...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Set up scaling of your Python application so that it runs smoothly while using only necessary resources.',
    }
  }
  ]} />
  ...
  {
    type: 'link',
    href: '/python/how-to/build-process#customise-python-build-environment',
  ...
  {
    type: 'link',
    href: '/python/how-to/deploy-process#customise-python-runtime-environment',
