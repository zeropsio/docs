...
We have created a repository, a *recipe*, containing the most simple Python web application, so you don't need to write any code yet. Choose from the options below which suits you best:
