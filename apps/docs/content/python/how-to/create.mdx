...
Python service with "app" hostname is configured to listen on tcp ports 8000, 8001 and on udp port 9000. Python service will run on version 3.12 with a custom vertical and horizontal scaling. Following secret env variables will be configured:
