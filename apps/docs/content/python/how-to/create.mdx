...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type <code>python</code> and version.
        <br />
        Set type:{' '}
        <code>
          python<span>@</span>&lt;version&gt;
        </code>{' '}
        or{' '}
        <code>
          python<span>@</span>latest
        </code>
        <br />
        <br />
        <b>Limitations:</b>
        <br />
        Following Python major versions are currently supported: <i>3.8</i>,
        <i>3.9</i>,<i>3.10</i>,<i>3.11</i>,<i>3.12</i>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <a href="/python/how-to/create#set-auto-scaling-configuration">
    ...
    <tr>
      ...
      <td>
        ...
        for{' '}
        <a href="/python/how-to/create#horizontal-auto-scaling">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/python/how-to/env-variables#env-variable-restrictions">
          restrictions
        </a>
        .
      </td>
