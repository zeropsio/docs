...
<p>The base runtime environment contains {data.alpineCurrentVersion}, the selected major version of Python, <a href="/references/cli">Zerops command line tool</a>, <code>pip</code> and <code>git</code>.</p>
