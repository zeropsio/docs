...
description: Learn how to trigger build & deploy pipeline in python service on Zerops.
---
...
1. Add <a href="/python/how-to/build-pipeline#add-zeropsyml-to-your-repository">`zerops.yml`</a> to your repository.
