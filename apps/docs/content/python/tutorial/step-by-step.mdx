...
<details><summary>3. In the left menu, click on <b>Import services</b>, copy & paste the contents of this <a href="https://github.com/zeropsio/recipe-python-hello-world/blob/main/import-service/description.yml">yaml file</a> and click on <b>Import service</b>.</summary>
<p>
