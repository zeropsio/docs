...
description: Get started with the Zerops cloud platform with our knowledge base.
image: /og.png
slug: /
...
export const runtimes = [
    ...
    { name: "Ruby", link: "/ruby/overview", icon: <Icons.ruby/> },
...
export const databases = [
    ...
    { name: "ClickHouse", link: "/clickhouse/overview", icon: <Icons.clickhouse/> },
...
Fully managed S3 compatible storage running on a separate infrastructure and persistent disk volumes that can be mounted to multiple services.
...
<Button variant="secondary"><Link href="/features/scaling">Read more about autoscaling and high availability</Link></Button>
