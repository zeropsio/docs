...
<Button variant="secondary">
  <Link href="/features/infrastructure">Read more about the project infrastructure</Link>
</Button>
...
<Button variant="secondary">
  <Link href="/features/scaling-ha">Read more about autoscaling and high availability</Link>
</Button>
...
<Button variant="secondary">
  <Link href="/features/pipeline">Read more about the build and deploy pipeline</Link>
</Button>
...
<Button variant="secondary">
  <Link href="/features/developer-first">Read more about our developer first approach</Link>
</Button>
