...
export const runtimes = [
    ...
    { name: "Static", icon: <Icons.computer-desktop/> },
...
export const databases = [
    ...
    { name: "Elasticsearch", icon: <Icons.elasticsearch/> },
    { name: "Meilisearch", icon: <Icons.meilisearch/> },
...
export const storages = [
    ...
    { name: "Shared storage", icon: <Icons.server/> },
]
