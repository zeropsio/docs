---
title: Meilisearch
desc: Production-ready Meilisearch in Zerops platform with managed infrastructure and automatic security configuration. Deploy and run search with zero operational overhead.
---
