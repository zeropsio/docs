...
- **Single-node stateful apps**: Prometheus, Gitea, and similar applications that keep their state in a local data directory — see the [Gitea recipe ↗](https://github.com/zeropsio/recipe-gitea) for a complete example built on Local Storage
