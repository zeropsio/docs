...
Each Zerops project includes a base storage quota for backups:
- **Lightweight Package**: 5 GB included
- **Serious Package**: 25 GB included
...
- Storage limited to your project's quota (5GB or 25GB)
...
2. **Manage storage efficiently**:
   - Regularly check usage in the Project Overview & Service Backup tabs
...
**Cause**: High backup frequency, long retention periods, or many protected tags.
...
4. **Upgrade Package**: Consider upgrading to the "Serious" package for larger storage quota
