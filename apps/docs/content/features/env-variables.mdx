...
When importing services using YAML configuration files, you can define secret variables using the `envSecrets` map:
...
#### Bulk editing
Click "Edit multiple secret variables in .env format" to open an editor where you can:
- Add new variables
