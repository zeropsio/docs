...
description: Learn how to work with environment variables on Zerops.
---
...
These restrictions apply to all [types of env variables](#types-of-env-variables-in-zerops).
