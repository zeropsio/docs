...
<DocCardList items={[
  ...
  { type: 'link', href: '/features/coding-agents', label: 'Infrastructure for Coding Agents', customProps: { icon: Icons['sparkles'], description: 'Put a coding agent on top of the same infrastructure.' } },
]} />
