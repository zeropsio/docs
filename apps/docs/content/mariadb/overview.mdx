  ...
  items={[
    ...
    },
    {
      ...
      customProps: {
        ...
        description:
          'Dive in all Zerops has to offer for your MariaDB application.',
      },
    },
    {
      type: 'link',
      ...
      customProps: {
        icon: Icons['github'],
        description:
          'Get inspired by already existing repositories, ready to be imported to Zerops. Filter is applied for simple applications with MariaDB, feel free to browse them all.',
      },
    },
  ]}
/>
