...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type <code>mariadb</code> and version.
        <br />
        Set type:{' '}
        <code>
    ...
    <tr>
      ...
      <td>
        ...
        <b>Limitations:</b>
        <br />
        <a href="/mariadb/tech-details/limitations">Learn more</a> about
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/mariadb/how-to/create#set-auto-scaling-configuration">
