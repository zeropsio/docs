...
| **description**        | **Optional.** Description of the new project.                                 | Max. 255 characters. |
...
:::note
The MariaDB service **name** and **mode** are fixed after the service is created. They can't be changed later.
:::
