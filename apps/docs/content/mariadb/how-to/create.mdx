...
<tbody>
  ...
  <tr>
    <td>
      <b>mode</b>
		...
		<td>
      Defines the operation mode of MariaDB service.<br/>
  ...
  <td><b>verticalAutoscaling</b></td>
		<td><b>Optional.</b> Defines <a href="/mariadb/how-to/create#set-auto-scaling-configuration">custom vertical auto scaling parameters</a>.<br/>
