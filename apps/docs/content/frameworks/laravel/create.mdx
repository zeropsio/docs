...
Following Php Nginx major versions are currently supported:

<UnorderedList data={data.nginxMajorVersions} />
...
[Learn more](/nginx/how-to/scaling) about Php Nginx auto scaling.
