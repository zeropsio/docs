...
1. Using a Zerops subdomain (yourapp.zerops.io)
...
Add your custom domain through the Zerops dashboard and you'll receive a DNS records to configure in your domain registrar:
...
> **Note**: You can choose to use only IPv4 (A record) by requesting a unique IPv4 address in Zerops.
