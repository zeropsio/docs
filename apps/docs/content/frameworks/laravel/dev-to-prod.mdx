...
Creating a project in Zerops is the first step to deploying your Laravel application.
...
<p align="center">
  <Image
    lightImage="/img/gui/serious-core.webp"
    darkImage="/img/gui/serious-core.webp"
    alt="Laravel Serious Package"
    caption="Serious Package"
    width="95%"
    height="auto"
  />
</p>
