---
title: Twill CMS for Local Development
description: A comprehensive Twill CMS setup for local development, providing a complete stack with PostgreSQL database, Redis-compatible KV store, object storage, and automated deployment pipeline, configured for cost-efficient workflows.
---
...
This recipe provides a comprehensive Twill CMS setup with PostgreSQL database, Redis-compatible store, object storage, and automated deployment pipeline, designed for **local development** with cost-efficient resource allocation and the [Lightweight](/features/pricing#understanding-projects) core package. This means:
