---
title: Laravel Jetstream Production Environment
description: A high-availability production environment for Laravel Jetstream with enterprise-grade capabilities, featuring PostgreSQL and automated deployment pipeline.
---
...
The app has been set up to utilize PostgreSQL service and includes Jetstream's authentication scaffolding. Your application's deployment process is managed through [zerops.yml](/zerops-yml/specification), which handles:
