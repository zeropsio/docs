...
:::tip
Confused about choosing between Lightweight and Serious Project Core? Read more at [laravel/dev-to-prod](/frameworks/laravel/dev-to-prod).
:::
...
:::tip
Confused about choosing between Lightweight and Serious Project Core? Read more about it at [laravel/dev-to-prod](/frameworks/laravel/dev-to-prod).
:::
