...
description: Go through the step by step tutorial for deno on Zerops.
---
...
<details>
  <summary>
    ...
    contents of this{' '}
    <a href="https://github.com/zeropsio/recipe-deno/blob/main/zerops-project-import.yml">
      yaml file
    </a>{' '}
...
7. Feel free to make any changes to your project, fork the repo or connect your own. Also see other <a href="https://github.com/zeropsio?q=deno&type=all&language=&sort=">Deno recipes</a> on our Github page.
