---
title: Delete MongoDB service
---
## Delete MongoDB service in Zerops GUI
...
## Delete MongoDB using zCLI
zCLI is the Zerops command-line tool. To delete the MongoDB service via the command-line, follow these steps:
