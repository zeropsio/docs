...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Specifies the service type <code>mongodb</code> and version.
        <br />
        Set type:{' '}
        <code>
          mongodb<span>@</span>4
      ...
      <td>
        Currently only MongoDB <i>4</i> is available.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Defines the operation mode of MongoDB service.
        <br />
        <br />
        <b>HA</b>
        <br />
        Creates a MongoDB cluster with 3 database containers. This mode is
        ...
        <b>NON_HA</b>
        <br />
        Zerops will create a MongoDB database installed in a single container.
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/mongodb/how-to/create#set-auto-scaling-configuration">
