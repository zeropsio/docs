...
export const Badge = ({ className, variant, children }) => {
    return (React.createElement("span", { className: clsx("text-compact-x-small-plus px-docs_0.25 py-0 rounded-docs_sm border border-solid text-center", variant === "purple" &&
