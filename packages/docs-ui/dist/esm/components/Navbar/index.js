...
export const Navbar = ({ logo, items, showSearchOpener = true, showColorModeToggle = true, additionalActionsBefore, additionalActionsAfter, mobileMenuButton, isLoading, className, }) => {
