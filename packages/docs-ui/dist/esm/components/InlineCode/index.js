...
export const InlineCode = (props) => {
    return (React.createElement(CopyButton, { text: props.children, buttonClassName: clsx("bg-transparent border-0 p-0 inline text-medusa-fg-subtle group", "font-monospace") },
