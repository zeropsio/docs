...
const InlineCode = (props) => {
    return (react_1.default.createElement(components_1.CopyButton, { text: props.children, buttonClassName: (0, clsx_1.default)("bg-transparent border-0 p-0 inline text-medusa-fg-subtle group") },
